...
def main(args, task=None, model_state=None):
    ...
    if args.load_emissions:
        ...
        n_task = OmegaConf.load("/root/storage/fairseq/examples/wav2vec/config/finetuning/base_100h.yaml").task
        saved_cfg.task = OmegaConf.merge(n_task,saved_cfg.task)
        ...
        with open('trans.txt', 'w') as f:
            for sample in t:
                ...
                for i, sample_id in enumerate(sample["id"].tolist()):
                    ...
                    print(f"{hyp_words}\t{tgt_words}", file=f)
